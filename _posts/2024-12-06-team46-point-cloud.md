...
- **Voting Loss**: Encourages accurate prediction of offsets between input points and ground truth object centers, defined as:$\mathcal{L}_{vote} = \frac{1}{N}\sum_{i=1}^{N} ||\text{Predicted Offset}_i - \text{Ground Truth Offset}_i||_2$
